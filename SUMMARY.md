...
* [Kom godt i gang](README.md)
* [GUI: Navigation](navigation.md)
* [GUI: Projekter](projects.md)
...
* [Valg af målbilleder](processing-images-gui/choosing-target-images.md)
* [Start af behandlingen](processing-images-gui/starting-the-processing.md)
* [Overvågning af behandlingen](processing-images-gui/monitoring-the-processing.md)
* [Afslutning af behandlingen](processing-images-gui/finishing-the-processing.md)

## PROJEKTINDSTILLINGER

* [Projektindstillinger](project-settings/project-settings.md)
* [Formler til multispektrale indekser](project-settings/multispectral-index-formulas.md)
...
* [Linux Oversigt](linux/linux-overview.md)
* [Linux Installation](linux/linux-installation.md)
* [NVIDIA Jetson-vejledning](linux/nvidia-jetson-guide.md)

## Behandlingsarkitektur

* [Dynamisk beregnings tilpasning](processing-architecture/dynamic-compute-adaptation.md)
* [Behandlingspipeline](processing-architecture/processing-pipeline.md)
