...
Hvis du udskriver de kalibrerede billeder i Chloros som typiske JPG- eller TIFF-filer, beregnes reflektansprocenten ved at dividere pixelværdien med billedformatets bitdybde. For JPG divideres med 255, og for TIFF divideres med 65.535. Du kan også vælge PERCENT-formatet i Chloros, og så vil hver pixel variere fra en procentværdi på 0,0 til 1,0 (0 % til 100 % refleksion). Husk blot, at nogle billedapplikationer ikke kan acceptere procentbilleder (flydende komma), og at de er store i forhold til lagerplads.
